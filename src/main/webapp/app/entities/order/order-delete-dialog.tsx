...
export const OrderDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication9App.order.delete.question">
        <Translate contentKey="jhipsterSampleApplication9App.order.delete.question" interpolate={{ id: orderEntity.id }}>
