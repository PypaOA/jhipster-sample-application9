...
export const CustomerDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication9App.customer.delete.question">
        <Translate contentKey="jhipsterSampleApplication9App.customer.delete.question" interpolate={{ id: customerEntity.id }}>
